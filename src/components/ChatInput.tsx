...
interface Props {
  onResolved: (chat: ChatInfo, url: string) => void;
  disabled: boolean;
}
...
export default function ChatInput({ onResolved, disabled }: Props) {
  ...
  // Filter history by current url content (case-insensitive substring match)
  ...
  function handleBlur() {
    // Delay so a click on a suggestion has time to fire before hiding
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Input row with integrated dropdown */}
